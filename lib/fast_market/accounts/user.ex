defmodule FastMarket.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, FastMarket.Repo)
  ...
  """
  def valid_password?(%FastMarket.Accounts.User{hashed_password: hashed_password}, password)
