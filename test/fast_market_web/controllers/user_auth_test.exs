defmodule FastMarketWeb.UserAuthTest do
  use FastMarketWeb.ConnCase, async: true

  alias FastMarket.Accounts
  alias FastMarketWeb.UserAuth
  import FastMarket.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, FastMarketWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      FastMarketWeb.Endpoint.subscribe(live_socket_id)
